...
- MAT分析hprof来定位内存泄露的原因所在
  ...
  ![img](../../img/memory-leak-8.jpg)

  B)分析持有此类对象引用的外部对象

  ![img](../../img/memory-leak-9.png)

  C)分析这些持有引用的对象的GC路径

  ![img](../../img/memory-leak-10.png)

  D)逐个分析每个对象的GC路径是否正常

  ![img](../../img/memory-leak-11.png)
